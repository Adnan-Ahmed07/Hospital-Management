...
import { ArrowRight, ChevronRight, ChevronLeft, Play, Calendar, User, Activity, Heart, Brain, Bone, Eye, Microscope, ShieldCheck, X, Award, CheckCircle } from 'lucide-react';
          ...
          <div className="bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col lg:flex-row relative group">
             ...
             <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center relative z-10">
               ...
               <p className="text-slate-400 text-lg mb-8 leading-relaxed">
                 AD Hospital stands as a beacon of medical excellence, seamlessly blending advanced scientific capabilities with deep human compassion. As a JCI-accredited facility, we are committed to delivering superior clinical outcomes through rigorous safety standards and a tireless dedication to patient well-being.
               </p>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Precision Medicine</h4>
                      <p className="text-slate-500 text-xs mt-1 leading-relaxed">Leveraging AI-driven diagnostics and robotic surgery for treatments defined by accuracy and faster recovery.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Holistic Care</h4>
                      <p className="text-slate-500 text-xs mt-1 leading-relaxed">Our multidisciplinary approach ensures every treatment plan is tailored to the physical and emotional needs of the patient.</p>
                    </div>
                  </div>
               </div>
